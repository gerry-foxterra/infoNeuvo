    ...
    L.drawVersion = "0.4.9", L.Draw = {}, L.drawLocal = {
        ...
        edit: {
            toolbar: {
                ...
                buttons: {
                    ...
                    remove: "Remove temporary layers.",
        ...
        _endPoint: function(e, i, o) {
            if (this._mouseDownOrigin) {
                ...
                s < 10 && L.Browser.touch ? this._finishShape() : Math.abs(n) < 9 * (t.devicePixelRatio || 1) && this.addVertex(o.latlng), this._enableNewMarkers()
            }
        ...
        _getMeasurementString: function() {
            ...
            return t = this._measurementRunningTotal + e.distanceTo(i), L.GeometryUtil.readableDistance(t, this.options.metric, this.options.feet, this.options.nautic)
        },
